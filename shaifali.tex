...
\begin{resume}
    ...
    Cloud Platform (OpenStack, AWS, Docker), Full Stack Web Dev (Python, Django, Bootstrap), Database (PostgreSQL, MongoDB), Data Science, Unix-like (Ubuntu).

    % Professional Experience
    \section{\mysidestyle Employment\\Activies}

    \begin{list2}
    \item \textbf{Full Stack Developer at Zaya Learning Labs} \hspace{45mm} Jan 2016 onwards \\ Python/Django front end and back end engineer to develop distributed web app for Zaya Learning Labs.\url{http://zaya.in/}
    ...
    \begin{list2}
	\item \textbf{Master of Computer Applications} \hspace{47mm} \textbf{CGPA: 8.76/10}(till 4th semester) \\ International Institute of Professional Studies, Devi Ahilya University \hspace{17mm} July 2013 - May 2016
	\end{list2}
    ...
    \item \textbf{AWS S3 Video Compress}: Full Stack Python/Django, AWS S3, Celery, Redis, PostgreSQL, ffmpeg, Bootstrap web development; Upload video on AWS S3, compress video through ffmpeg and Celery queues, tasks; store compressed video back on S3. \url{https://github.com/exploreshaifali/aws_s3_video_compress}
